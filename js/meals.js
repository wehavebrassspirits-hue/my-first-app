...
// q: (任意) クックパッド検索キーワード。単品名だが表記が特殊で
//    検索精度が落ちる献立に、検索用の語を指定する。
...
const MENUS = [
  ...
  { id: 16, name: "あさりの酒蒸しとごはん", parts: ["あさりの酒蒸し", "ごはん"], items: ["あさりの酒蒸し", "だし巻き卵", "ごはん・味噌汁"], temp: ["mild","hot"], rainOk: true, effort: 1, stamina: 1, spicy: false, allergens: ["卵"], ingredients: ["あさり","酒","にんにく","卵","米","味噌"] },
  ...
  { id: 51, name: "ミネストローネと厚切りトースト", parts: ["ミネストローネ", "厚切りトースト"], items: ["ミネストローネ", "厚切りトースト", "オムレツ"], temp: ["cold","mild"], rainOk: true, effort: 2, stamina: 2, spicy: false, allergens: ["小麦","卵"], ingredients: ["ベーコン","トマト缶","キャベツ","じゃがいも","食パン","卵"] },
  ...
  { id: 116, name: "味噌ラーメンと餃子", parts: ["味噌ラーメン", "餃子"], items: ["味噌ラーメン", "焼き餃子", "メンマ"], temp: ["cold"], rainOk: true, effort: 2, stamina: 2, spicy: false, allergens: ["小麦"], ingredients: ["中華麺","もやし","コーン","豚ひき肉","餃子","味噌だれ"] },
  ...
  { id: 137, name: "そうめんと天ぷら", parts: ["そうめん", "天ぷら"], items: ["薬味そうめん", "野菜と海老の天ぷら", "枝豆"], temp: ["hot"], rainOk: false, effort: 2, stamina: 1, spicy: false, allergens: ["小麦","えび"], ingredients: ["そうめん","えび","なす","かぼちゃ","みょうが","めんつゆ","枝豆"] },
  ...
  { id: 142, name: "ざるうどんと唐揚げ", parts: ["ざるうどん", "唐揚げ"], items: ["ざるうどん", "鶏の唐揚げ", "冷やしトマト"], temp: ["hot"], rainOk: false, effort: 2, stamina: 3, spicy: false, allergens: ["小麦"], ingredients: ["うどん","鶏もも肉","片栗粉","トマト","めんつゆ","薬味ねぎ"] },
  ...
  { id: 146, name: "冷やしトマトと餃子", parts: ["冷やしトマト", "餃子"], items: ["焼き餃子", "冷やしトマト", "わかめスープ"], temp: ["hot"], rainOk: true, effort: 2, stamina: 2, spicy: false, allergens: ["小麦"], ingredients: ["豚ひき肉","キャベツ","にら","餃子の皮","トマト","米"] },
  ...
  { id: 149, name: "いなり寿司と天ぷら", parts: ["いなり寿司", "天ぷら"], items: ["いなり寿司", "野菜天ぷら", "お吸い物"], temp: ["mild","hot"], rainOk: false, effort: 2, stamina: 1, spicy: false, allergens: ["大豆","小麦"], ingredients: ["油揚げ","米","かぼちゃ","なす","ちくわ","天ぷら粉"] },
  ...
  // ── その他ごはんもの ─────────────────────────────────
  { id: 157, name: "とうもろこしごはんと焼き魚", parts: ["とうもろこしごはん", "焼き魚"], items: ["とうもろこしごはん", "鮭の塩焼き", "味噌汁"], temp: ["hot","mild"], rainOk: true, effort: 2, stamina: 1, spicy: false, allergens: [], ingredients: ["とうもろこし","米","生鮭","小松菜","味噌"] },
